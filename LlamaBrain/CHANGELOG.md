...
All notable changes to LlamaBrain for Unity will be documented in this file.
...
### Added
- Initial release of LlamaBrain for Unity
- Core AI integration with llama.cpp server
- UnityBrainAgent component for AI-powered NPCs
- BrainServer component for server management
- PersonaConfig system for character personalities
...
- Comprehensive unit tests (EditMode and PlayMode)
...
### Previous Versions
- **0.2.01**: Initial Unity integration

---

**Note**: This changelog tracks changes from the initial Asset Store release. For development history, see the git repository. 