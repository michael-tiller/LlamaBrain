...
- How to create and configure a UnityBrainAgent
- Basic dialogue interaction

**Key Components:**
- BrainServer prefab with settings
- UnityBrainAgent with persona configuration
- Simple dialogue UI
...
**Key Components:**
- Multiple UnityBrainAgent instances
...
- **BrainAgent.prefab**: Pre-configured UnityBrainAgent
...
2. Select the UnityBrainAgent GameObject
