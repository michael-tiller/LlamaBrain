...
/// <summary>
/// This namespace contains the core components for the UnityBrainDemo project.
/// </summary>
namespace UnityBrainDemo.Runtime.Core
{
  ...
  /// </summary>
  [CreateAssetMenu(fileName = "PromptComposerSettings", menuName = "UnityBrain/Prompt Composer Settings")]
