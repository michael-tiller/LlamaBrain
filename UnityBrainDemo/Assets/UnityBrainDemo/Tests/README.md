...
This directory contains tests for the UnityBrain integration using Unity's Test Framework (UniTest).

## Test Structure

### EditMode Tests
Tests that run in the Unity Editor without entering Play Mode:
- **UnityBrainSettingsTests.cs** - Tests for configuration validation
...
- **UnityBrainServerTests.cs** - Tests for UnityBrainServer component
...
- **Namespaces**: `UnityBrainDemo.Tests.EditMode` or `UnityBrainDemo.Tests.PlayMode`
