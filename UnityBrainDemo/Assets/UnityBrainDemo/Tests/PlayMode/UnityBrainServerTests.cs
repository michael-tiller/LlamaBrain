...
namespace UnityBrainDemo.Tests.PlayMode
{
  public class UnityBrainServerTests
  {
    ...
    [UnityTest]
    public IEnumerator UnityBrainServer_WithNullSettings_HandlesGracefully()
    {
      ...
      var nullSettingsServer = nullSettingsServerObject.AddComponent<UnityBrainServer>();
    ...
    [UnityTest]
    public IEnumerator UnityBrainServer_DoubleInitialization_HandlesCorrectly()
    {
      // Arrange
    ...
    [UnityTest]
    public IEnumerator UnityBrainServer_CreateClient_WhenNotInitialized_ReturnsNull()
    {
      // Arrange - Create a new server instance without initialization
      var uninitializedServerObject = new GameObject("UninitializedTestServer");
      var uninitializedServer = uninitializedServerObject.AddComponent<UnityBrainServer>();
      uninitializedServer.Settings = null;

      // Expect the error log message
      LogAssert.Expect(LogType.Error, "[LLM] UnityBrainServer not initialized. Cannot create client.");
    ...
    [UnityTest]
    public IEnumerator UnityBrainServer_CreateClient_WhenInitialized_ReturnsValidClient()
    {
      // Arrange
    ...
    [Test]
    public void UnityBrainServer_SettingsWithCustomPort_ConfiguresCorrectly()
    {
      // Arrange
      settings.Port = 8080;
    ...
    [UnityTest]
    public IEnumerator UnityBrainServer_ProcessConfigValidation_WorksCorrectly()
    {
      // Arrange
    ...
    [UnityTest]
    public IEnumerator UnityBrainServer_WithCustomLlmSettings_InitializesCorrectly()
    {
      // Arrange
