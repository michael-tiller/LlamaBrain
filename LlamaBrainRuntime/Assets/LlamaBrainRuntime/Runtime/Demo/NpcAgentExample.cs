...
/// </summary>
namespace LlamaBrain.Runtime.Demo
{
  /// <summary>
  ...
  public class NpcAgentExample : MonoBehaviour
  {
    ...
    private async UniTaskVoid InitializeAgentAsync()
    {
      try
      {
        ...
        {
          agent = GetComponent<LlamaBrainAgent>();
          Debug.Log("[NpcAgentExample] Found LlamaBrainAgent component");
        }

        if (agent == null)
        {
          Debug.LogError("[NpcAgentExample] No LlamaBrainAgent component found on this GameObject");
          return;
        }
    ...
    /// <summary>
    /// Gets the LlamaBrainAgent component for external access
    /// </summary>
    /// <returns>The LlamaBrainAgent component</returns>
    public LlamaBrainAgent GetBrainAgent()
    {
      return agent;
    }
