...
namespace Whisper
{
    ...
    public class WhisperManager : MonoBehaviour
    {
        ...
        private string modelPath = "Whisper/ggml-tiny.en.bin";
        ...
        public async Task InitModel()
        {
            ...
            try
            {
                ...
                // Log system info to show available backends (CPU, Vulkan, etc.)
                var systemInfo = WhisperWrapper.GetSystemInfo();
                LogUtils.Log($"Whisper system info: {systemInfo}");
            }
            catch (Exception e)
            {
